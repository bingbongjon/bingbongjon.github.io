...
const title = 'Jon Chapman | Designer + Developer';
const description =
    'Portfolio of Jon Chapman – a multidisciplinary designer & developer with a focus on motion and user experience.';

const disciplines = ['Designer', 'Musician', 'Creator'];
...
const Home = () => {
    ...
    return ( <
        ...
        /> <
        ProjectSummary id = "project-1"
        alternate sectionRef = { projectOne }
