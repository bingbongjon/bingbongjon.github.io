...
const ProjectDM = lazy(() =>
    import ('pages/DeviceModels'));
const ProjectDTT = lazy(() =>
    import ('pages/DevTechTools'));
const Articles = lazy(() =>
...
const repoPrompt = `\u00A9 2017-${new Date().getFullYear()} Jon Chapman\n\nCheck out the source code: https://github.com/bingbongjon/portfolio`;
...
const AppRoutes = () => {
    ...
    return ( <
        ...
        <
        link rel = "canonical"
        href = { `https://codyb.co${pathname}` }
        /> <
        /Helmet> <
        VisuallyHidden showOnFocus as = "a"
        ...
        onEnter = { reflow } >
        {
            status => ( <
                ...
                element = { < Contact / > }
                /> <
                Route path = "/projects/device-models"
                element = { < ProjectDM / > }
                /> <
                Route path = "/projects/devtech-tools"
                element = { < ProjectDTT / > }
                /> <
                Route path = "/articles/*"
                element = { < Articles / > }
